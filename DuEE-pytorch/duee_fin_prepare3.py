...
def docs_data_process(path,flag=True):
    """docs_data_process"""
    lines = read_by_lines(path)
    sentences = []
    for line in lines:
        d_json = json.loads(line)
        sentences.extend(marked_doc_2_sentence(d_json,flag))
...
if __name__ == "__main__":
    ...
    test_sent = docs_data_process("{}/test2.json".format(data_dir), flag=False)
    write_by_lines("{}/test2.json".format(sentence_dir), test_sent)
    ...
    test_tri = data_process("{}/test2.json".format(sentence_dir), "trigger")
    write_by_lines("{}/test2.tsv".format(trigger_save_dir), test_tri)
    print("train {} dev {} test1 {}".format(
    ...
    test_role = data_process("{}/test2.json".format(sentence_dir), "role")
    write_by_lines("{}/test2.tsv".format(role_save_dir), test_role)
    print("train {} dev {} test1 {}".format(
    ...
    test_enum = enum_data_process("{}/test2.json".format(sentence_dir))
    write_by_lines("{}/test2.tsv".format(enum_save_dir), test_enum)
    print("train {} dev {} test1 {}".format(
