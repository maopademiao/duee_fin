...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--trigger_file", help="trigger model predict data path", default='./ckpt2/DuEE-Fin/trigger/test1_pred.json')#required=True)
    parser.add_argument(
        "--role_file", help="role model predict data path",default='./ckpt2/DuEE-Fin/role/test1_pred.json')# required=True)
    parser.add_argument(
        "--enum_file", help="enum model predict data path", default='./ckpt2/DuEE-Fin/enum/test_pred.json')#required=True)
    parser.add_argument("--schema_file", help="schema file path",default='./conf/DuEE-Fin/event_schema.json')# required=True)
    parser.add_argument("--save_path", help="save file path", default='./submit/test_duee_fin.json')#required=True)
