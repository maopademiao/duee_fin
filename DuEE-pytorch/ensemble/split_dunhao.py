...
parser.add_argument("--originalpath", type=str, default='/home/xuwd/projects/DuEE-pytorch/submit/new2/test2.all_cpt_all_ids.json', help="original result path")
parser.add_argument("--splitpath", type=str, default='/home/xuwd/projects/DuEE-pytorch/submit/new2/test2.all_cpt_all_ids-split.json', help="writepath")
parser.add_argument("--max_argument_length", type=int, default=40, help="max argument length")

args = parser.parse_args()

splitpath = args.splitpath
originalpath = args.originalpath
max_length = args.max_argument_length
