...
parser.add_argument("--originalpath", type=str, default='/home/xuwd/projects/DuEE-pytorch/submit/new2/last-duee-fin.json', help="original result path")
parser.add_argument("--splitpath", type=str, default='/home/xuwd/projects/DuEE-pytorch/submit/new2/last-duee-fin-splitdou.json', help="writepath")
